...
class StudioViews(TestCase):
    ...
    def test_studio_page_logged_out(self):
        ...
        self.assertRedirects(
            response,
            f'/accounts/login/?next=/studio/{self.free_lesson.lesson_id}/')
        self.assertContains(
            response,
    ...
    def test_studio_page_invalid_lesson(self):
        ...
        response = self.client.get(f'/studio/{self.invalid_lesson_id}/',
                                   follow=True)
    ...
    def test_studio_page_paid_lesson_is_purchased(self):
        ...
        self.assertContains(response,
                            html.escape(self.paid_lesson.description))
