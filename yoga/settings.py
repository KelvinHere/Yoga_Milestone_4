...
if 'DEVELOPMENT' in os.environ:
    ...
    EMAIL_HOST_USER = os.envron.get('EMAIL_HOST_USER')
    EMAIL_HOST_PASSWORD = os.envron.get('EMAIL_HOST_PASS')
    DEFAULT_FROM_EMAIL = os.envron.get('EMAIL_HOST_USER')